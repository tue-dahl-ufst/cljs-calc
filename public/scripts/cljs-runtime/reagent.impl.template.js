...
var G__36268 = o;
goog.object.set(G__36268,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__36269 = o;
goog.object.set(G__36269,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__36270 = props;
var G__36270__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36270,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__36270);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36270__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__36271 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36271,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__36271;
}
})(),id_class);
...
var vec__36273 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36273,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36273,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36273,(2),null);
...
var temp__5739__auto___36313 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___36313 == null)){
} else {
var key_36314 = temp__5739__auto___36313;
(jsprops.key = key_36314);
}
...
var temp__5739__auto___36316 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___36316 == null)){
} else {
var key_36317 = temp__5739__auto___36316;
(jsprops.key = key_36317);
}
...
var temp__5739__auto___36324 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___36324 == null)){
} else {
var key_36325 = temp__5739__auto___36324;
(jsprops.key = key_36325);
}
...
var temp__5739__auto___36329 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___36329 == null)){
} else {
var key_36330 = temp__5739__auto___36329;
(jsprops.key = key_36330);
}
...
var temp__5739__auto___36331 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___36331 == null)){
} else {
var key_36332 = temp__5739__auto___36331;
(jsprops.key = key_36332);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__36276_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__36276_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__36277 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36277,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36277,(1),null);
...
break;
default:
var G__36342 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__36343 = compiler;
v = G__36342;
compiler = G__36343;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template36283 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template36283 = (function (opts,id,fn_to_element,meta36284){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template36283.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_36285,meta36284__$1){
var self__ = this;
var _36285__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template36283(self__.opts,self__.id,self__.fn_to_element,meta36284__$1));
}));

(reagent.impl.template.t_reagent$impl$template36283.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_36285){
var self__ = this;
var _36285__$1 = this;
return self__.meta36284;
}));

(reagent.impl.template.t_reagent$impl$template36283.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template36283.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template36283.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template36283.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template36283.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta36284","meta36284",1525588755,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template36283.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template36283.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template36283");

(reagent.impl.template.t_reagent$impl$template36283.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template36283");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template36283.
 */
reagent.impl.template.__GT_t_reagent$impl$template36283 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template36283(opts__$1,id__$1,fn_to_element__$1,meta36284){
return (new reagent.impl.template.t_reagent$impl$template36283(opts__$1,id__$1,fn_to_element__$1,meta36284));
});

}

return (new reagent.impl.template.t_reagent$impl$template36283(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
